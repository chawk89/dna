...
*Package was originally named "DNAnalyze" but we were assigned "OpenFDA" which isn't a particularly relevant name for our package (I believe some of the content from the samle proposal.rmd file was carried over in our submission). We broadened the scope slighlty to help users analyze any applicable trait in a DNA file as long as they have the GWAS summary statistics file with the relevant fields (as opposed to just top personality traits from the 23andMe study).

CONTRIBUTIONS:
Alex Kern - primary author of polyGenerate and several of the functions relating to polygentic scores and manhattan plots; co-author of the description and challenges report summary.
Colby Hawker - primary author of clustering and effect size functionality, contributor to polygentic score generatation and plotting functions, and developer of the core R package components and documentation; co-athor of report summary.
...
You can generate polygenic scores for personality traits with `polyScore`
...
You can investigate the relevant SNP chromosome locations with `manhatten_plot`
